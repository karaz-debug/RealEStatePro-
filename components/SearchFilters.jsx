...
const SearchFilters = () => {
    ...
    return (
        <Flex bg="gray.50" p="4" justifyContent="center" flexWrap="wrap">
            {filters?.map((filter) => (
            ...
            <Flex flexDir="column">
                ...
                {showLocations && (
                    <Flex flexDir="column" pos="relative" paddingTop="2">
                        <Input placeholder="Type here" value={searchTerm} w="300px"
                            focusBorderColor="gray.300" onChange={(e) => setSearchTerm(e.target.value)} />
                        {searchTerm !== "" && (
                            <Icon as={MdCancel} pos="absolute" cursor="pointer" right="5" top="5"
                                zIndex="100" onClick={() => setSearchTerm("")} />
                        )}
